...
Copilot CLI diagnostics, feedback bundles, debug-log collection, and redaction share a safety boundary that is separate from normal telemetry. This discussion bridges [Diagnostics, feedback, and debug bundles](diagnostics-feedback-debug-bundles.md), [Content exclusion and redaction](../03-tools-integrations-security/content-exclusion-and-redaction.md), and [Telemetry, update, and shutdown](telemetry-update-and-shutdown.md).
