...
- [Shell command execution lifecycle](../04-tools-and-integrations/shell-command-execution-lifecycle.md) covers the shell output buffers that use `SessionFs` for large output.