...
- [Checkpoints, undo, rewind, and fork](../02-context-and-input/checkpoints-undo-rewind.md) explains user-visible rollback/branching behavior.
- [Conversation compaction](../02-context-and-input/conversation-compaction.md) explains checkpoint-producing semantic compression.
- [Memory and dynamic context board](../02-context-and-input/memory-and-context-board.md) explains the long-term context entries stored beside session history.
