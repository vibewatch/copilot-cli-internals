...
- [Overview](./00-overview/README.md)
  ...
  - [Main feature map for `app.js`](./00-overview/main-feature-map.md)
...
- [Context and input](./02-context-and-input/README.md)
  - [Prompt sources in `app.js`](./02-context-and-input/prompt-sources.md)
  ...
  - [Memory and dynamic context board in `app.js`](./02-context-and-input/memory-and-context-board.md)
  - [Conversation compaction and memory compression in `app.js`](./02-context-and-input/conversation-compaction.md)
...
- [Sessions and remote](./03-sessions-and-remote/README.md)
  ...
  - [Remote control implementation in `app.js`](./03-sessions-and-remote/remote-control-implementation.md)
...
- [Security and policy](./05-security-and-policy/README.md)
  - [Permission system design in `app.js`](./05-security-and-policy/permission-system-design.md)
...
- [Agents and automation](./07-agents-and-automation/README.md)
  - [Agent and task orchestration in `app.js`](./07-agents-and-automation/agent-task-orchestration.md)
  - [Autopilot and no-ask-user flags](./07-agents-and-automation/autopilot-and-no-ask-user.md)
  - [Fleet mode implementation in `app.js`](./07-agents-and-automation/fleet-mode.md)
...
- [Operations and research](./08-operations-and-research/README.md)
  - [Feature gates and rollout logic in `app.js`](./08-operations-and-research/feature-gates.md)
  ...
  - [Further documentation opportunities in `app.js`](./08-operations-and-research/documentation-opportunities.md)
