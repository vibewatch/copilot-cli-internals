...
Feature gates, generated source indexes, diagnostics, debug bundles, redaction boundaries, observability/update/shutdown, and the original documentation backlog.
...
|---|---|---|
| Operations and research section index | N/A — navigation page | Groups feature gates, source-index generation, diagnostics, debug-bundle redaction, observability, and documentation-research docs. |
...
flowchart TD
    ...
    Diagnostics --> Redaction[Debug bundle redaction]
    Redaction --> Security[Security and policy]
    ...
    click Redaction "./debug-bundle-redaction-boundaries/" "Open debug bundle and redaction boundaries"
    click Security "../05-security-and-policy/content-exclusion-and-redaction/" "Open content exclusion and redaction"
...
| [Debug bundle and redaction boundaries](./debug-bundle-redaction-boundaries.md) | What enters diagnostic bundles, which redaction layers apply, local archive versus secret gist risk, and remaining safety caveats. | `debug-bundle-redaction-boundaries.md` |
...
- Operational docs explain gates, logging, diagnostics, redaction boundaries, and shutdown.
- Read the debug-bundle redaction page before treating support archives or secret gists as safe-to-share artifacts.
