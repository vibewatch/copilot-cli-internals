...
For nearby systems, see [`permission-system-design.md`](./permission-system-design.md) for approval semantics, [`sessions-remote-cloud.md`](../03-sessions-and-remote/sessions-remote-cloud.md) for cloud sandbox sessions, [`feature-gates.md`](../08-operations-and-research/feature-gates.md) for gate resolution, [`tui-and-slash-commands.md`](../01-runtime-and-ui/tui-and-slash-commands.md) for slash-command hosting, [`prompt-sources.md`](../02-context-and-input/prompt-sources.md) for prompt wording, and [Main feature map](../00-overview/main-feature-map.md) for the broader feature map.