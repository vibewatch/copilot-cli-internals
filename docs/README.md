...
| Understand native and indexed-search boundaries | [Native `runtime.node` binary architecture](01-runtime-lifecycle/native-runtime-binary.md) → [Out-of-process native runtime bridge](01-runtime-lifecycle/out-of-process-native-runtime.md) → [Indexed repository search with tgrep and ripgrep](03-tools-integrations-security/indexed-search-tgrep-and-ripgrep.md) |
| Understand terminal text and desktop integration | [CLI native Unicode and desktop helper](01-runtime-lifecycle/cli-native-platform-helper.md) → [Interactive TUI and slash-command workflows](01-runtime-lifecycle/tui-and-slash-commands.md) → [Terminal setup and shell environment](01-runtime-lifecycle/terminal-setup-and-shell-environment.md) |
