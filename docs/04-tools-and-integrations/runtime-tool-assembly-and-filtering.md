...
- [Custom agents and skills packaging](../02-context-and-input/custom-agents-and-skills-packaging.md) covers where custom-agent `tools` declarations come from.
- [System events and UI projection](../03-sessions-and-remote/system-events-and-ui-projection.md) covers how `session.tools_updated` is projected to clients.