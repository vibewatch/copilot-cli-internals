...
- [Hooks and lifecycle automation](../05-security-and-policy/hooks-lifecycle-automation.md) explains runtime hook semantics and permission-sensitive hook behavior.
- [API and session event schema contracts](../03-sessions-and-remote/api-and-session-event-schemas.md) explains generated API/session-event schemas used by SDK clients.
