...
1. [`scheduled-prompts-and-command-queue.md`](../06-agents-automation/scheduled-prompts-and-command-queue.md)
2. [`settings-config-persistence.md`](../03-tools-integrations-security/settings-config-persistence.md)
3. [`system-events-and-ui-projection.md`](../04-sessions-persistence-remote/system-events-and-ui-projection.md)
4. [`web-search-url-fetching.md`](../03-tools-integrations-security/web-search-url-fetching.md)

Remaining gap-review set:

1. [`voice-mode-foundry-local.md`](../01-runtime-lifecycle/voice-mode-foundry-local.md)
2. [`terminal-setup-and-shell-environment.md`](../01-runtime-lifecycle/terminal-setup-and-shell-environment.md)
3. [`checkpoints-undo-rewind.md`](../02-context-model-loop/checkpoints-undo-rewind.md)
4. [`usage-quota-billing-metrics.md`](../02-context-model-loop/usage-quota-billing-metrics.md)
5. [`embedded-server-acp-protocol.md`](../01-runtime-lifecycle/embedded-server-acp-protocol.md)
6. [`diagnostics-feedback-debug-bundles.md`](../05-hosted-agent-ops/diagnostics-feedback-debug-bundles.md)
7. [`custom-agents-and-skills-packaging.md`](../06-agents-automation/custom-agents-and-skills-packaging.md)
8. [`session-store-sqlite-indexing.md`](../04-sessions-persistence-remote/session-store-sqlite-indexing.md)
9. [`content-exclusion-and-redaction.md`](../03-tools-integrations-security/content-exclusion-and-redaction.md)
...
Implemented as: [`attachments-and-file-ingestion.md`](../02-context-model-loop/attachments-and-file-ingestion.md)
...
Implemented as: [`ide-lsp-editor-integration.md`](../03-tools-integrations-security/ide-lsp-editor-integration.md)
...
Implemented as: [`git-repository-context.md`](../04-sessions-persistence-remote/git-repository-context.md)
...
Implemented as: [`scheduled-prompts-and-command-queue.md`](../06-agents-automation/scheduled-prompts-and-command-queue.md)
...
Implemented as: [`settings-config-persistence.md`](../03-tools-integrations-security/settings-config-persistence.md)
...
Implemented as: [`system-events-and-ui-projection.md`](../04-sessions-persistence-remote/system-events-and-ui-projection.md)
...
Implemented as: [`web-search-url-fetching.md`](../03-tools-integrations-security/web-search-url-fetching.md)
...
|---|---|
| Voice mode / Foundry Local | [`voice-mode-foundry-local.md`](../01-runtime-lifecycle/voice-mode-foundry-local.md), [`voice-runtime-workers-and-transcription.md`](../01-runtime-lifecycle/voice-runtime-workers-and-transcription.md) |
| Terminal setup and shell environment | [`terminal-setup-and-shell-environment.md`](../01-runtime-lifecycle/terminal-setup-and-shell-environment.md) |
| Checkpoints, undo, rewind, and fork | [`checkpoints-undo-rewind.md`](../02-context-model-loop/checkpoints-undo-rewind.md) |
| Usage, quota, and billing metrics | [`usage-quota-billing-metrics.md`](../02-context-model-loop/usage-quota-billing-metrics.md) |
| Embedded server / ACP / JSON-RPC protocol | [`embedded-server-acp-protocol.md`](../01-runtime-lifecycle/embedded-server-acp-protocol.md) |
| Diagnostics, feedback, and debug bundles | [`diagnostics-feedback-debug-bundles.md`](../05-hosted-agent-ops/diagnostics-feedback-debug-bundles.md) |
| Custom agents and skills packaging | [`custom-agents-and-skills-packaging.md`](../06-agents-automation/custom-agents-and-skills-packaging.md) |
| Session-store SQLite indexing | [`session-store-sqlite-indexing.md`](../04-sessions-persistence-remote/session-store-sqlite-indexing.md) |
| Content exclusion and redaction | [`content-exclusion-and-redaction.md`](../03-tools-integrations-security/content-exclusion-and-redaction.md) |
