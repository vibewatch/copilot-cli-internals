...
The current artifact is `1.0.71`. For a release-oriented view of newly added commands, settings, SDK methods, and native-boundary migrations, read [Copilot CLI 1.0.71 package delta](copilot-cli-1.0.71-delta.md).
