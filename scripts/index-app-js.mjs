...
const KNOWN_ANCHORS = [
  {
    ...
    anchors: ['var y1=new _s().name("copilot")', "RootProgram"],
  ...
  },
  {
    ...
    anchors: ['.action(async t=>{if(t.printDebugInfo', "NIn({", "oCe({", "--server", "--headless"],
  ...
  },
  {
    ...
    anchors: ["async function NIn(", "embeddedServer.registerSession"],
  ...
  },
  {
    ...
    anchors: ["async function oCe(", "async function u9r(", "session.task_complete"],
  ...
  },
  {
    ...
    anchors: ["async runAgenticLoop(", "async processQueue(){this.isProcessing", "tool.execution_complete"],
  ...
  },
  {
    ...
    anchors: [
      '.addOption(new mi("-r, --resume [value]"',
      '.option("--continue"',
      "session.start",
      "session.resume",
  ...
  },
  {
    ...
    anchors: [
      "async initializeAndValidateTools(){try{let e=await this.buildSettingsAndTools()",
      "buildSettingsAndTools(",
      "session.tools_updated",
    ],
  ...
  },
  {
    ...
    anchors: ["requestPermissionWithHooks(", "permission.requested", "allow-tool", "deny-tool"],
  ...
  },
  {
    ...
    anchors: ["mcpHostStateCreate()", "doInvokeToolWithTask(", "callToolStream", "taskSupport"],
  ...
  },
  {
    ...
    anchors: ["async function VM(", "setupExtensionsForSession", "session.extensions_loaded", "EXTENSIONS"],
  ...
  },
  {
    ...
    anchors: ["nR=class{tasks=new Map", "promoteAgentToBackground(", "waitForAgents()", "cancelRecursive("],
  ...
  },
  {
    ...
    anchors: ["S.toolTaskPrepareInput(", "Unknown agent_type:", "agent_type"],
  ...
  },
  {
    ...
    anchors: [
      '$_t=["explore","task","code-review","rubber-duck"]',
      'ozn=["research","rem-agent","security-review"]',
      'qLe=[...H_t,"general-purpose"]',
    ],
  ...
  },
  {
    ...
    anchors: ["SessionAgentExecutor.execute() called", "s?.multiTurnConfig", "this.notifySubagentComplete()"],
  ...
  },
  {
    ...
    anchors: [
      "S.featureFlagsAvailabilityJson()",
      "COPILOT_CLI_ENABLED_FEATURE_FLAGS",
      "getFlagWithExpOverride(",
      'persistenceResolvePath(AT(),"exp-cache"',
    ],
  ...
  },
  {
    ...
    anchors: ["var aW=class{disposables=[]", "S.otelResolveConfig", "COLLECT_DEBUG_LOGS", "/collect-debug-logs"],
...
const MAIN_PATHS = [
  {
    ...
    anchorSeeds: [
      'var y1=new _s().name("copilot")',
      '.action(async t=>{if(t.printDebugInfo',
      "async function NIn(",
      "async function oCe(",
      "async function u9r(",
      '.addOption(new mi("--server"',
      '.addOption(new mi("--headless"',
      '.addOption(new mi("--acp"',
    ],
  ...
  },
  {
    ...
    anchorSeeds: ["async runAgenticLoop(", "getCompletionWithTools", "preRequest", "history_truncated", "compaction_started", "rate limit"],
  ...
  },
  {
    ...
    anchorSeeds: ["tool.execution_start", "preToolUse", "requestPermissionWithHooks(", "tool.execution_complete"],
  ...
  },
  {
    ...
    anchorSeeds: [
      "nR=class{tasks=new Map",
      "S.toolTaskPrepareInput(",
      "SessionAgentExecutor.execute() called",
  ...
  },
  {
    ...
    anchorSeeds: [
      ...
      "deny-tool",
      "content exclusion",
      "sandboxCheckFilesystemAccess",
      "sandboxCheckNetworkAccess",
    ],
  ...
  },
  {
    ...
    anchorSeeds: [
      "/diagnose",
      "/collect-debug-logs",
      "var aW=class{disposables=[]",
      "S.otelResolveConfig",
      'new _s("update").summary("Download the latest version")',
    ],
