...
- maintenance/copilot-cli/latest-package-update.md
- maintenance/copilot-cli/latest-subsystem-review.md
...
3. Review every candidate in maintenance/copilot-cli/latest-subsystem-review.md. Inspect package entrypoints, callers, lifecycle/state, events or RPCs, cleanup, trust boundaries, and adjacent SDK/schema contracts before deciding.
...
9. Keep maintenance/copilot-cli/latest-package-update.md machine-generated; do not edit it. You must edit maintenance/copilot-cli/latest-subsystem-review.md to record reviewed decisions.
