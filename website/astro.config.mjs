      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Voice runtime workers', link: '/01-runtime-and-ui/voice-runtime-workers-and-transcription/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'End-to-end session lifecycle', link: '/03-sessions-and-remote/session-lifecycle-end-to-end/' },
            { label: 'Session support', link: '/03-sessions-and-remote/session-support-implementation/' },
            { label: 'Persistence pipeline', link: '/03-sessions-and-remote/persistence-pipeline/' },
            { label: 'SessionFs provider and state files', link: '/03-sessions-and-remote/session-fs-provider-and-state-files/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Runtime tool assembly', link: '/04-tools-and-integrations/runtime-tool-assembly-and-filtering/' },
            { label: 'Shell command execution', link: '/04-tools-and-integrations/shell-command-execution-lifecycle/' },
            { label: 'Validation and review toolchain', link: '/04-tools-and-integrations/coding-agent-validation-toolchain/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Debug bundle redaction boundaries', link: '/08-operations-and-research/debug-bundle-redaction-boundaries/' },
