      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'CLI runtime workflows', link: '/01-runtime-lifecycle/cli-runtime-workflows/' },
            ...
            { label: 'Observability and shutdown', link: '/05-hosted-agent-ops/observability-update-shutdown/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Built-in tool execution', link: '/03-tools-integrations-security/built-in-tool-execution-pipeline/' },
            { label: 'Shell command execution', link: '/03-tools-integrations-security/shell-command-execution-lifecycle/' },
            { label: 'MCP support', link: '/03-tools-integrations-security/mcp-support-implementation/' },
            { label: 'Plugin and extension architecture', link: '/03-tools-integrations-security/plugin-extension-architecture/' },
            { label: 'IDE, LSP, editor integration', link: '/03-tools-integrations-security/ide-lsp-editor-integration/' },
            { label: 'Permission system', link: '/03-tools-integrations-security/permission-system-design/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'End-to-end session lifecycle', link: '/04-sessions-persistence-remote/session-lifecycle-end-to-end/' },
            { label: 'Session support', link: '/04-sessions-persistence-remote/session-support-implementation/' },
            { label: 'Persistence pipeline', link: '/04-sessions-persistence-remote/persistence-pipeline/' },
            ...
            { label: 'Remote control', link: '/04-sessions-persistence-remote/remote-control-implementation/' },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Research home', link: '/99-research-atlas/' },
          ],
        },
      ],
    }),
